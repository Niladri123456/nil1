...
function ref(){
           ...
           var dt=escape(dt1);
           var path="http://www.indianwebanalyst.in/gpie.php?cname=Color%20Depth&col=c_color&dt="+dt;
...
?>
  ...
  <iframe id="chart" src="http://www.indianwebanalyst.in/gpie.php?cname=Color%20Depth&col=c_color" width="800" height="520">
