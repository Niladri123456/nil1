...
function ref(){
           ...
           var dt=escape(dt1);
           var path="http://www.indianwebanalyst.in/gpie.php?cname=Operating%20System&col=c_os&dt="+dt;
...
?>
  ...
  <iframe id="chart" src="http://www.indianwebanalyst.in/gpie.php?cname=Operating%20System&col=c_os" width="800" height="520">
