...
function ref(){
           ...
           var dt=escape(dt1);
           var path="http://www.indianwebanalyst.in/gpie.php?cname=Web%20Browser&col=c_browser&dt="+dt;
...
?>
  ...
  <iframe id="chart" src="http://www.indianwebanalyst.in/gpie.php?cname=Web%20Browser&col=c_browser" width="800" height="520">
