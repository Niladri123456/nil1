...
function ref(){
           ...
           var dt=escape(dt1);
           var path="http://www.indianwebanalyst.in/gpie.php?cname=Visitor's%20Language&col=c_language&dt="+dt;
...
?>
  ...
  <iframe id="chart" src="http://www.indianwebanalyst.in/gpie.php?cname=Visitor's%20Language&col=c_language" width="800" height="520">
